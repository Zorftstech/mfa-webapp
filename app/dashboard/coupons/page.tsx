    ...
    <DashboardLayout>
        <div style={{ height: 'auto'}}>
            ...
            <div className="flex flex-wrap  px-0">
                <CouponCard voucher_name='Christmas Voucher' event_name='Christmas24' discount='3% discount' date_text='Valid till Jan 2nd, 2025' />
                <CouponCard voucher_name='Valentine Voucher' event_name='Valentine24' discount='10% discount' date_text='Valid till Jan 2nd, 2025' />
            </div>
        </div>
    </DashboardLayout>
  )
