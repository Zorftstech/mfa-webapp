   ...
   return (
      <div className="container h-full">
         <div>
            <Link
               href={"/"}
               className="text-text flex w-fit items-center gap-2 font-bold hover:underline hover:transition hover:ease-in-out"
            >
         ...
         <section className="mx-auto flex h-full min-h-full max-w-lg flex-col justify-center py-12">
            ...
            <button
               ...
               onClick={() => googleLogin()}
               type="submit"
               className="flex w-full items-center justify-center gap-4 rounded-md  border py-4   text-[1rem] font-[500] shadow-3  transition-opacity duration-300 ease-in-out hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50
              disabled:hover:cursor-not-allowed disabled:hover:opacity-50"
            >
               <Image
                  width={30}
                  height={30}
                  src="/images/auth/googleIcon.svg"
                  alt=""
                  className=""
               />
