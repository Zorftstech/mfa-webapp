  ...
  return (
    <div className="flex-1 p-2">
      ...
      <div className="mt-2 flex w-full items-center justify-start gap-2">
        ...
        <Text className="rounded-2xl border border-green-100 bg-green-100 px-4 py-2" size={'xs'} weight={'normal'}>
          In stock
        </Text>
      </div>
      <div className="mt-4 flex flex-wrap items-center justify-start gap-2">
        ...
        <Text className="rounded-2xl border border-gray-300 px-4 py-1 text-gray-600" size={'xs'} weight={'normal'}>
          Paint Bucket 3KG
        </Text>
        <Text className="rounded-2xl border border-gray-300 px-4 py-1 text-gray-600" size={'xs'} weight={'normal'}>
          50KG Basket
